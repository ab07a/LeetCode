public class LengthOfLongestFibonacciSubsequence {
    ...
    public static void main(String[] args) {
        LengthOfLongestFibonacciSubsequence lSubsequence = new LengthOfLongestFibonacciSubsequence();
        System.out.println(lSubsequence.lenLongestFibSubseq(new int[]{1,2,3,4,5,6,7,8}));
    }
}
